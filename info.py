...
USERNAME = environ.get('USERNAME', "https://telegram.me/BharwajBhavit")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002479013444'))
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/bMRRt9gp/photo-2024-12-15-13-42-18-7484275667727548420.jpg')
START_IMG = environ.get('START_IMG', 'https://freeimage.host/i/3YWgV1a https://freeimage.host/i/3YWrTTN https://freeimage.host/i/3YWgMqg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002479013444'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002488966442'))
URL = environ.get('URL', '')
...
REF_PREMIUM = 10
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002197825290 -1002288926485')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002442403236'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002635939366')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002479013444'))
